...
Plane Surface(1) = {1, 2};        // Important line. This defines the surface that is enclosed by the curves defined above.
Plane Surface(10) = {1};
Plane Surface(20) = {2};
//+
...
// Physical Surface("boundary1") = {57, 61};

Physical Surface("wall1") = {35,39};
//+
// Physical Surface("boundary2") = {207, 123, 165, 211, 127, 169};

Physical Surface("Patch1") = {45};

Physical Surface("AmazingPatch") = {20};

// Physical Surface("Patch2") = {90};
//+
