...
Extrude {0, 0, -1.0} { Surface{101,102}; }

// Delete {Surface{113,117}; Curve{104,105,112}; Point{103};}
Delete {Curve{104}; }

Physical Surface("Walls1") = {121,125,129,133};
Physical Surface("Wall2") = {150};
Physical Surface("Bottom") = {134,151};
