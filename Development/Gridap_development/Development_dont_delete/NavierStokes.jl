...
function main(distribute,np,nc)
  ...
  # local_xh = localpart(xh)
  # uh, ph = local_xh.fields
  # uh = local_xh.single_fe_functions[1]
  # ph = xh.single_fe_functions[2] 
  writevtk(Ω,"TestingNavierStokes_jl",cellfields=["uh"=>uh,"ph"=>ph])
