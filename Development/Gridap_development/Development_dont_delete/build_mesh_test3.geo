...
Curve Loop(101) = {101, 102, 2, 3, 4, 5};
...
out[] = Extrude {0, 0, -1.0} { Curve{1:5}; };

Curve Loop(202) = {107,111,115,119,103};
Plane Surface(302) = {202};

Physical Surface("Walls1") = {110,114,118,122};
Physical Surface("Wall2") = {106};
Physical Surface("Bottom") = {302};

Surface Loop(1) = {101, 102, 106, 110, 114, 118, 122};
Volume(1) = {1};
Physical Volume("Domain") = {1};

// On meshing this gives: Error   : No elements in volume 1
