...
\item Work example with non-trivial bathymetry, like a basin separated by ridge. See \texttt{ExampleSolution\_0.8.ipynb}. DONE. 
\item Add variable $f$. Work mid-latitude $\beta$-plane example with flat bottom. See \texttt{ExampleSolution\_0.9.ipynb}. DONE. 
