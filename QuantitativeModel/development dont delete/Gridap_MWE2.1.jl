...
# Faster assembly of complex-valued function uing cached intermediate functions and function composition, not function calls inside the integral.
...
C_fn2 = AU_fe * dot_gradp + BU_fe
l2(v) = ∫( real( (∇(v) ⋅ VectorValue(1im, 1.0)) * C_fn2 ) )dΩ
@time "op2 = AffineFEOperator(a, l2, U, V)" op2 = AffineFEOperator(a, l2, U, V)
Psi = Gridap.solve(op2)

# 10. Visualization with Paraview: Looks good!
writevtk(Ω,"Gridap_MWE2.1_solution",cellfields=["Psi"=>Psi, "psurf"=>psurf])